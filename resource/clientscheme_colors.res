Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"244 114 43 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"0 0 0 255" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"90 255 0 255" // Heal color
		"G_Hit"					"244 114 43 255" // Hit color
		...
		"G_LightGrey"			"210 199 199 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"0 0 0 64" // Transparent menu color
		...
		"G_Killfeed_Base"			"42 42 42 255" // Killfeed Base color
		"G_Killfeed_Local"			"232 232 232 240" // Killfeed Local color
		...
		"G_KillfeedRed"				"255 65 65 255" // Killfeed red text
		"G_KillfeedIcon"			"232 232 232 255" // Killfeed icon color
		"G_CustomHealthValue"		"120 120 120 255"
		"G_MainMenuOverlay"			"0 0 0 0" // Main Menu overlay color
		"G_MainMenuPanel"			"46 43 42 255" // Main Menu panel color
		"G_MainMenuButton"			"62 62 62 255" // Main Menu button color
		"G_MainMenuButtonHover"		"244 114 43 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"209 204 198 255" // Main Menu button text color
		"G_MainMenuButtonHoverFg"	"234 234 234 255" // Main Menu hovered button text color
		"G_MainMenuShader" 			"0 0 0 0" // Main Menu shader color
		"G_BackpackItemBg"			"25 25 25 255" // Backpack item bg color
		"G_LoadoutItemBg"			"25 25 25 255" // Loadout item bg color
		"G_MenuBg"					"35 35 35 255" // Menu bg color
		...
		"G_ItemDescriptionPanelBg"	"25 25 25 255" // Item description panel bg
		"G_ButtonBg"				"62 62 62 255" // Button bg color
		"G_ButtonText"				"214 206 200 255" // Button text color
		"G_ButtonHoverBg"			"230 104 43 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"244 114 43 255" // Button selected bg color
		...
		"G_ItemMeterBg"				"62 62 62 255" // Item meter bg
		"G_ItemMeterBorder"			"62 62 62 255" // Item meter border color
		"G_MenuShader"				"0 0 0 100" // Menu shader color
		"G_XPBar"					"244 114 43 255" // XP Bar color
		"G_ItemEffectMeterLineColor"	"120 120 120 130"
		"G_MvmLobbyPanelBg"			"40 40 40 255"
		"G_MvmLobbyPanelText"		"220 220 220 255"
		
		// Crosshairs
		"G_Crosshair1Color"		"35 217 0 255" // Crosshair1 color
		"G_Crosshair2Color"		"35 217 0 255" // Crosshair2 color
		...
		"TFOrange"			"244 114 43 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"244 114 43 255" // Highlight color
